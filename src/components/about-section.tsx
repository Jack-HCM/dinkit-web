...
// NOT mounted on the page yet — the "Read our story" destination page
// doesn't exist. Keep this ready to enable once that page ships.
export function AboutSection() {
  return (
    <section className="relative flex w-full max-w-[1280px] flex-col items-center px-6">
      <div className="relative z-10 aspect-[761/507] w-[55%] max-w-[500px] -mb-[20%]">
        <Image
      ...
      <div className="flex w-full flex-col items-center gap-16 rounded-t-[24px] bg-white px-6 pt-[14%] pb-16 sm:px-10 md:flex-row md:items-center md:gap-10 md:px-16 md:pt-[10%]">
