...
export function SiteFooter() {
  return (
    <div className="relative w-full max-w-[1280px] overflow-hidden rounded-t-[24px] bg-white px-6 pt-16 sm:px-10 md:px-16">
      ...
      <div className="relative -mx-6 mt-6 h-[120px] w-[calc(100%+48px)] sm:-mx-10 sm:h-[150px] sm:w-[calc(100%+80px)] md:-mx-16 md:h-[190px] md:w-[calc(100%+128px)]">
        <Image
